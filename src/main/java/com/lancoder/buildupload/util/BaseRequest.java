...
public abstract class BaseRequest {
     ...
     * @return
     */
    public String postData(String url, Map<String, String> requestHeaders, Map<String, Object> dataMap) {
        CloseableHttpClient httpClient = HttpClients.createDefault();
        HttpPost httpPost = new HttpPost(url);
        List<BasicNameValuePair> params = new ArrayList<>();
        if (dataMap != null) {
            dataMap.forEach((key, value) -> params.add(new BasicNameValuePair(key, value.toString())));
        }
